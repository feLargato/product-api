package com.product.productapi.config.rabbit;
...
public class RabbitConfig {
    ...
    @Bean
    public Binding productStockMqBinding(TopicExchange topicEx) {
    ...
    @Bean
    public Binding salesConfirmationMqBinding(TopicExchange topicEx) {
        return BindingBuilder
